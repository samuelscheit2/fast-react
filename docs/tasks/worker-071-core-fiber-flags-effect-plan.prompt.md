...
Objective:
Produce a report-only implementation plan for Rust core fiber flags, subtree flags, effect lists, passive/layout/insertion effect metadata, host mutation flags, and commit phase data flow.
...
- Record the full report in `worker-progress/worker-071-core-fiber-flags-effect-plan.md`.
