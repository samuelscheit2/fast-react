...
After setting the goal, call get_goal if available and record the active goal status/objective in your report, then read WORKER_BRIEF.md, MASTER_PLAN.md, MASTER_PROGRESS.md, worker-progress/worker-007-scheduler-fiber.md, worker-progress/worker-070-core-update-queue-plan.md, and worker-progress/worker-078-hook-effect-ring-plan.md. Do not read ORCHESTRATOR.md unless explicitly asked by the orchestrator.
