...
After setting the goal, call get_goal if available and record the active goal status/objective in your report, then read WORKER_BRIEF.md, MASTER_PLAN.md, MASTER_PROGRESS.md, worker-progress/worker-007-scheduler-fiber.md, worker-progress/worker-070-core-update-queue-plan.md, worker-progress/worker-071-core-fiber-flags-effect-plan.md, worker-progress/worker-078-hook-effect-ring-plan.md, worker-progress/worker-081-reconciler-root-scheduler-act-plan.md, and worker-progress/worker-099-core-hook-state-queue-plan.md if it exists. Do not read ORCHESTRATOR.md unless explicitly asked by the orchestrator.
