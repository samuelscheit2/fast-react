...
Read `WORKER_BRIEF.md`, `MASTER_PLAN.md`, `MASTER_PROGRESS.md`, `worker-progress/worker-007-scheduler-fiber.md`, `worker-progress/worker-008-renderer-host-config.md`, `worker-progress/worker-010-initial-scaffold.md`, and `worker-progress/worker-012-host-config-traits.md` first. Do not read `ORCHESTRATOR.md`; it is for the orchestrator role, not workers.
