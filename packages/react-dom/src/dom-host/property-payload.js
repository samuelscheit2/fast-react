...
const PRIVATE_STYLE_OBJECT_DIFF_FAKE_DOM_COMMIT_METADATA_KIND =
  'FastReactDomPrivateStyleObjectDiffFakeDomCommitMetadataRecord';
const PRIVATE_STYLE_OBJECT_DIFF_FAKE_DOM_COMMIT_STATUS =
  'accepted-private-dom-style-object-diff-fake-dom-commit-metadata';
const PRIVATE_DANGEROUS_HTML_UPDATE_FAKE_DOM_COMMIT_METADATA_KIND =
  'FastReactDomPrivateDangerousHtmlUpdateFakeDomCommitMetadataRecord';
const PRIVATE_DANGEROUS_HTML_UPDATE_FAKE_DOM_COMMIT_STATUS =
  'accepted-private-dom-dangerous-html-update-fake-dom-commit-metadata';
