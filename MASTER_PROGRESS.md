...
| worker-037-react-dom-type-inventory | running in tmux worktree; nested subagents allowed | Add deterministic React DOM declaration/runtime type-gap inventory files | `../fast-react-worker-037-react-dom-type-inventory/worker-progress/worker-037-react-dom-type-inventory.md` |
