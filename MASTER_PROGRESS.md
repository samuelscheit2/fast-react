...
| worker-036-react-dom-export-oracle | running in tmux worktree; nested subagents allowed | Add deterministic React DOM runtime export, descriptor, condition, and blocked-subpath oracle files | `../fast-react-worker-036-react-dom-export-oracle/worker-progress/worker-036-react-dom-export-oracle.md` |
