...
pub use root_scheduler::{
    ...
    RootSyncFlushPlan, RootTaskScheduleOutcome, RootTaskScheduleRecord, ScheduledRootUpdateResult,
    collect_sync_flush_plan, ensure_root_is_scheduled, execute_scheduled_root_callback,
