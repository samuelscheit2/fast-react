...
use crate::complete_work::{
    ...
    HostComponentManagedChildMutationKindForCanary, OffscreenRevealCommitMetadataRecord,
    ...
    fn fmt(&self, formatter: &mut Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::MetadataPlacementSiblingMismatch {
                ...
                formatter,
                "root {} managed child placement fiber {} expected append sibling metadata, found {:?}",
                root.raw(),
                fiber.slot().get(),
                placement_sibling
            ),
    ...
    fn root_commit_effect_list_layout_effect_execution_gate_records_error_capture_metadata_without_public_callbacks()
     {
        ...
        let destroy_error =
            FunctionComponentLayoutEffectCallbackInvocationErrorHandle::from_raw(51);
