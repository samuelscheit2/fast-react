...
#[cfg(test)]
use self::managed_child::HOST_ROOT_MANAGED_CHILD_COMMIT_EXECUTION_BLOCKERS;
use self::record::host_root_commit_order_passive_source_order;
#[allow(
    unused_imports,
    reason = "public deletion cleanup record path is preserved for host-work handoffs"
)]
pub use deletions::HostRootDeletionCleanupRecord;
#[allow(
    unused_imports,
    reason = "crate-visible deletion traversal record path is preserved for focused canaries"
)]
pub(crate) use deletions::HostRootDeletionSubtreeTraversalGateRecord;
#[allow(
    unused_imports,
    reason = "crate-visible deletion traversal status path is preserved for focused canaries"
)]
pub(crate) use deletions::HostRootDeletionSubtreeTraversalGateStatus;
pub use deletions::{
    HostRootDeletionCleanupLog, HostRootDeletionCleanupOrderGateRecord,
    HostRootDeletionCleanupOrderGateSnapshot, HostRootDeletionCleanupOrderPhase,
};
pub(crate) use deletions::{
    HostRootDeletionListRecord, HostRootDeletionSubtreeHostDetachmentPlanErrorForCanary,
    HostRootDeletionSubtreeHostDetachmentPlanForCanary,
    HostRootDeletionSubtreeTraversalGateSnapshot,
};
use deletions::{
    collect_deletion_list_metadata, collect_pending_host_node_deletion_cleanup,
    find_nearest_host_parent_for_deletion, materialize_deletion_cleanup_order_gate,
    materialize_deletion_subtree_host_detachment_plan_for_canary,
    materialize_deletion_subtree_traversal_gate, materialize_host_node_deletion_cleanup_log,
};
...
#[allow(
    unused_imports,
    reason = "crate-visible managed-child commit handoff paths are preserved for focused canaries"
)]
...
#[allow(
    unused_imports,
    reason = "crate-visible root commit callback and recovery diagnostic paths are preserved for canaries"
)]
pub(crate) use record::{
    ...
    RootCommitErrorOptionCallbackRecord, host_root_commit_recovery_snapshot_for_canary,
    host_root_render_failure_recovery_commit_evidence_for_canary,
    record_root_commit_error_option_callbacks,
};
#[allow(
    unused_imports,
    reason = "public commit order diagnostic paths remain stable through root_commit"
)]
pub use record::{
...
#[allow(
    unused_imports,
    reason = "crate-visible ref lifecycle metadata paths are preserved for commit and host-work canaries"
)]
pub(crate) use refs::{
    HostRootDomRefCallbackCommitGateBlocker, HostRootDomRefCallbackCommitGateRecord,
    HostRootDomRefCallbackCommitGateSnapshot, HostRootDomRefCallbackCommitGateStatus,
    HostRootRefCallbackExecutionHandoffBlocker, HostRootRefCallbackExecutionHandoffRecord,
    HostRootRefCallbackExecutionHandoffSnapshot, HostRootRefCallbackExecutionHandoffStatus,
    HostRootRefCallbackExecutionPhase, HostRootRefCleanupReturnExecutionGateBlocker,
    HostRootRefCleanupReturnExecutionGateRecord, HostRootRefCleanupReturnExecutionGateSnapshot,
    HostRootRefCleanupReturnExecutionGateStatus, HostRootRefCleanupReturnExecutionPhase,
    HostRootRefCommitAction, HostRootRefCommitRecord, HostRootRefCommitSnapshot,
    HostRootRefDetachReason, HostRootRefHostComponentUpdateOrderKindForCanary,
    HostRootRefHostComponentUpdateOrderRecordForCanary,
    HostRootRefHostComponentUpdateOrderSnapshotForCanary,
};
use refs::{
    collect_pending_ref_commit_metadata, materialize_dom_ref_callback_commit_gate,
