...
mod root_bridge_requests {
    ...
    pub(crate) const NATIVE_ROOT_BRIDGE_WORKER_THREAD_CLEANUP_HOOK_CANONICAL_SET_MISMATCH_CODE:
        &str = "FAST_REACT_NAPI_CLEANUP_HOOK_CANONICAL_SET_MISMATCH";
    ...
    #[cfg(test)]
    pub(crate) const NATIVE_ROOT_BRIDGE_CLEANUP_GENERATION_CURRENTNESS_FORGED_CLEANUP_ROW_CODE:
        &str = "FAST_REACT_NAPI_CLEANUP_GENERATION_CURRENTNESS_FORGED_CLEANUP_ROW";
    #[cfg(test)]
    pub(crate) const NATIVE_ROOT_BRIDGE_CLEANUP_GENERATION_CURRENTNESS_CROSS_WORKER_THREAD_CODE:
        &str = "FAST_REACT_NAPI_CLEANUP_GENERATION_CURRENTNESS_CROSS_WORKER_THREAD_HANDOFF";
    #[cfg(test)]
    ...
    #[cfg(test)]
    pub(crate) const NATIVE_ROOT_BRIDGE_CLEANUP_GENERATION_CURRENTNESS_REPLAYED_OR_RETIRED_CODE:
        &str = "FAST_REACT_NAPI_CLEANUP_GENERATION_CURRENTNESS_REPLAYED_OR_RETIRED";
    #[cfg(test)]
    pub(crate) const NATIVE_ROOT_BRIDGE_CLEANUP_GENERATION_CURRENTNESS_DUPLICATE_CLEANUP_CODE:
        &str = "FAST_REACT_NAPI_CLEANUP_GENERATION_CURRENTNESS_DUPLICATE_CLEANUP";
    #[cfg(test)]
    pub(crate) const NATIVE_ROOT_BRIDGE_CLEANUP_GENERATION_CURRENTNESS_REENTRY_AFTER_RETIRE_CODE:
        &str = "FAST_REACT_NAPI_CLEANUP_GENERATION_CURRENTNESS_REENTRY_AFTER_RETIRE";
    #[cfg(test)]
    ...
    #[cfg(test)]
    pub(crate) const NATIVE_ROOT_BRIDGE_CLEANUP_GENERATION_CURRENTNESS_REENTRY_EVIDENCE_IDS:
        &[&str] = &[
...
mod tests {
    ...
    fn native_root_bridge_cleanup_generation_currentness_canary_rejects_source_record_identity_smuggling()
     {
        ...
        let forged_lifecycle_consumer =
            lifecycle_consumer.with_rows_for_test(forged_lifecycle_rows);
        assert_cleanup_generation_currentness_rejection(
    ...
    fn native_root_bridge_cleanup_generation_currentness_canary_rejects_replay_and_retired_lifecycle()
     {
        ...
        assert!(
            retired_lifecycle_consumer.rows().iter().any(
                |row| row.root_handle_state_after() == NativeRootBridgeRootHandleState::Retired
            )
        );
        assert!(
            NATIVE_ROOT_BRIDGE_CLEANUP_GENERATION_CURRENTNESS_REENTRY_EVIDENCE_IDS
    ...
    fn cleanup_hook_preflight_callable_rejects_duplicate_or_missing_canonical_roles() {
        ...
        for (id, rows, expected_rejected_count) in [
            ...
            let callable =
                validate_native_root_bridge_worker_thread_cleanup_hook_preflight_rows(rows);
