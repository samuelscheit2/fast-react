...
test("private admission 820 rejects top-level public and runtime alias claims", () => {
  const gate = evaluatePrivateAdmission820Gate({
    rowOverrides: {
      [worker803]: {
        ...
        publicSchedulerFlushExecutionAvailable: true,
        schedulerTimingAdmissionClaimed: true,
        schedulerDelayedActRootAdmissionClaimed: true,
        schedulerDelayedRendererRootAdmissionClaimed: true,
  ...
  assertSubset(
    [
      ...
      `${worker803}.reactDomManagedChildCompatibilityClaimed`,
      `${worker803}.reactTestRendererCompatibilityClaimed`,
      `${worker803}.broadReconcilerTraversalClaimed`,
      `${worker803}.hydrationEventsRefsResourcesFormsClaimed`,
      ...
      `${worker803}.nativeBridgeCompatibilityClaimed`,
      ...
      `${worker803}.publicSchedulerFlushBehaviorExecuted`,
      `${worker803}.publicSchedulerFlushExecutionAvailable`,
      `${worker803}.schedulerTimingAdmissionClaimed`,
      `${worker803}.schedulerDelayedActRootAdmissionClaimed`,
      `${worker803}.schedulerDelayedRendererRootAdmissionClaimed`,
      `${worker803}.routesAcceptedMockSchedulerFlushHelperMetadata`,
      `${worker803}.invokesPublicSchedulerFlushHelper`,
      `${worker803}.acceptsTopLevelDelayedActRootWorkAsPublicActEvidence`,
      `${worker803}.queueFlushingReady`,
      `${worker803}.rendererRootsReady`,
      `${worker803}.passiveEffectsReady`,
      `${worker803}.continuationFlushingReady`,
      `${worker803}.drainsPublicSchedulerTaskQueue`,
      `${worker803}.drainsPublicReactActQueue`,
      `${worker803}.executesQueuedWork`,
      `${worker803}.executesEffects`,
      `${worker803}.executesRendererWork`,
      `${worker803}.executesRendererRoots`
    ],
