...
Print the checked-in scheduler 0.27.0 public root behavior oracle artifact. This
command does not fetch npm metadata, download tarballs, execute scheduler, or
claim Fast React scheduler compatibility.
`);
  process.exit(0);
}
