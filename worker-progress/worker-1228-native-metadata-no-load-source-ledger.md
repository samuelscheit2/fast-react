...
- The accepted product-side ledger verifies source-owned Rust identifiers and JS
  factory shape, and the conformance gate re-evaluates implementation files
  directly instead of accepting worker prose.
