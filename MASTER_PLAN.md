...
- Worker 1300 is repair-blocked for react-test-renderer TestInstance query-bridge
  ...
  gaps, followed by control-flow, spread override, nested-return, guard-binding,
  duplicate-key, helper-order, `var` redeclaration, and escaped-key gaps.
