...
| worker-021-element-object-oracle | Implement deterministic element-object conformance oracle and Fast React mismatch reporting | `tests/conformance/**`, `worker-progress/worker-021-element-object-oracle.md` | workers 017,020 | queued |
| worker-022-host-operation-errors | Add structured host operation errors for invalid test-renderer operations | `crates/fast-react-host-config/**`, `crates/fast-react-test-renderer/**`, optional compile-only `crates/fast-react-reconciler/**`, `worker-progress/worker-022-host-operation-errors.md` | workers 018,019 | queued |
