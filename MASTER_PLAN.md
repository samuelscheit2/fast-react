...
| worker-025-children-helpers | Add a deterministic `Children` helper oracle and implement covered JS facade behavior | `packages/react/**`, `tests/smoke/**`, `tests/conformance/**`, `worker-progress/worker-025-children-helpers.md` | workers 014,017,023,024 | running |
